...
class AnalyticsPage(QWidget):
    ...
    def __init__(self, controller=None, parent=None):
        ...
        self._date_from = QDateEdit(QDate(2026, 10, 1))
        ...
        self._date_to = QDateEdit(QDate(2026, 10, 23))
    ...
    def _build_kpi_cards(self) -> None:
        ...
        if kpi_data is not None:
            if hasattr(kpi_data, "total_comments"):
                ...
                total = kpi_data.get("total_comments", 8934)
                appr = kpi_data.get("approved_count", 6840)
                flag = kpi_data.get("flagged_count", 1674)
                reje = kpi_data.get("rejected_count", 420)
            else:
        ...
        metrics = [
            ("TOTAL COMMENTS", f"{total:,}", "▲ +12.4% vs last cycle", "#0F172A"),
